...
//RedemptionUO Start		
		public override void OnGaveMeleeAttack( Mobile defender )
      {
        ...
        base.OnGaveMeleeAttack( defender);
                ...
                if ( SummonMaster != null && SummonMaster.Skills.Magery.Fixed + SummonMaster.Skills.Poisoning.Fixed >= 2000 )// 2000 = 200 total
                        defender.ApplyPoison( this, Poison.Deadly );
 
                if ( SummonMaster != null && SummonMaster.Skills.Magery.Fixed + SummonMaster.Skills.Poisoning.Fixed >= 1500 )// 1500 = 150 total
                        defender.ApplyPoison( this, Poison.Greater );
 
                if ( SummonMaster != null && SummonMaster.Skills.Magery.Fixed + SummonMaster.Skills.Poisoning.Fixed >= 1000 )// 1000 = 100 total
