...
//RedemptionUO Start
        ...
        {
            get { return m_CBDBlessed; }
            set { m_CBDBlessed = value; }
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            if (this is BaseClothing && ((BaseClothing)this).CBDBlessed)
            {
        ...
        private class UnBlessEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                {
                    if (m_Item is BaseClothing && ((BaseClothing)m_Item).CBDBlessed)
                    {
                        Container pack = m_From.Backpack;
                        if (pack != null)
                        {
                            pack.DropItem(new ClothingBlessDeed());
                            m_From.SendMessage("A clothing bless deed has been placed in your backpack.");
                            m_Item.LootType = LootType.Regular;
                            m_Item.CBDBlessed = false;
							m_Item.Delete();
                        }
                    }
                }
